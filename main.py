...
# ================== CONFIG ==================
# ВСТАВЬ ТОКЕН НИЖЕ
API_TOKEN = "8746857507:AAHYIRxMEYJt1trNKUtzpfaFWoQBpXAhDp0"
DB_PATH = "casino.db"
...
async def cmd_start(m: Message):
    ...
    await m.answer("🎰 Бот запущен на Railway!\nИспользуй кнопки для игры.", reply_markup=kb)
...
async def start_go(m: Message):
    ...
    game['status'] = False
    if not game['bets']:
        return await m.answer("❌ Ставок не было.")
